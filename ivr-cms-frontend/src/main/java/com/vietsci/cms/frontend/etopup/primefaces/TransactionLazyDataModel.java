 ...
 *
 */
public class TransactionLazyDataModel extends LazyDataModel<Trans> {
  ...
  public TransactionLazyDataModel(TransactionManagementService transactionManagementService, TransactionManagementDTO transactionManagementDTO) {
  ...
  public List<Trans> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
    ...
    datasource = transactionManagementService.getTransactionList(transactionManagementDTO);
    setRowCount(transactionManagementService.countTotalRecord(transactionManagementDTO));
    return datasource;
  }
